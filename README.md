...
아키텍처 :
          ...
          master 브랜치 - MVVM, Clean Architecture, DI - Hilt, xml -> compose 변경작업

          book-mvvm-clea_arch_hilt 브랜치 - MVVM, Clean Architecture, DI - koin -> Hilt 변경작업 
...
master가 가장 최근의 업데이트(?)를 반영하는 브랜치입니다. **최신 업데이트 날짜 2024.11.21**
