...
아키텍처 :
          ...
          book-mvvm-cleanArch-compose 브랜치 - MVVM, Clean Architecture, DI - Hilt, compose 적용 중 (mastser에는 반영 안할 예정입니다.)
...
master가 가장 최근의 업데이트(?)를 반영하는 브랜치입니다. **최신 업데이트 날짜 2023.01.10**
